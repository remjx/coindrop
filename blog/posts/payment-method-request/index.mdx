...
<div style={{marginBottom: "1.5rem"}}>
    <Center>
        <Image src="/blog-content/payment-method-request/phone-with-apps.jpg" width="328" height="328" alt="Smartphone with apps on homescreen" />
    </Center>
</div>
...
Send an e-mail to [contact@coindrop.to](mailto:contact@coindrop.to) with the following information:
- Payment method name
